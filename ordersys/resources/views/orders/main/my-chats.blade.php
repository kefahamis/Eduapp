...
<script type="text/javascript">
    ...
    function initChat(recipient){
       ...
       jQuery.ajax({
        url: "{{ url('main/my-chats/set-recipient') }}",
        method: 'POST',
        data: {
            recipient: recipient,
        },
   ...
   function listRecipients(){
    ...
    jQuery.ajax({
        url: "{{ url('main/my-chats/list-recipients') }}",
        method: 'POST',
        data: {
            data_str: data_str,
        },
...
function selectRecipient(recipient){
    ...
    $("#textarea-div").show();
    jQuery.ajax({
        url: "{{ url('main/my-chats/select-recipient') }}",
        method: 'POST',
        data: {
            recipient: recipient,
        },
...
function sendMessage(recipient,message){
   $("#your_message").val('');
   jQuery.ajax({
    url: "{{ url('main/my-chats/send-message') }}",
    method: 'POST',
    data: {
        recipient: recipient,
...
function listMessages(recipient){
    ...
    var data_str = "list";
    jQuery.ajax({
        url: "{{ url('main/my-chats/list-messages') }}",
        method: 'POST',
        data: {
            recipient: recipient,
        },
