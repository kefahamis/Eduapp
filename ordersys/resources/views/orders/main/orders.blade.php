...
<div class="container">
	<div class="row justify-content inner-content_bg_gray">
		...
		<div class="row" style="min-height: 800px; padding-top: 25px;">
			...
			<div class="writer-n_orders-table-v2__tab-content-row writer-n_orders-table-v2__tab-content-row_notify">
			...
			<div class="writer-n_orders-table-v2__tab-content-row">
				<div class="order-view-v2__header-button">
					...
					<a href="{{url(url_prefix().'/place-order')}}" class="js_button_order js_button_order btn btn_customer-n_orders-heading btn_primary-accent js_crm_order_list_button_click js_button_order_ga">Place order for client</a>
